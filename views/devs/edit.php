  ...
  <form action="index.php?controller=developer&action=update" method="post">
    ...
    <div class="form-floating mb-3">
      <select class="form-select" id="rol" name="rol" aria-label="Floating label select example"
        value="<?= $data['developer']['rol'] ?? '' ?>">
        <option value="Developer" <?= $data['developer']['rol'] == 'Developer' ? 'selected' : '' ?>>Developer</option>
        <option value="ProductOwner" <?= $data['developer']['rol'] == 'ProductOwner' ? 'selected' : '' ?>>ProductOwner
        </option>
        <option value="ScrumMaster" <?= $data['developer']['rol'] == 'ScrumMaster' ? 'selected' : '' ?>>ScrumMaster
        </option>
      </select>
    ...
    <div class="form-floating mb-3">
      <select class="form-select" id="scrumTeamId" name="scrumTeamId" aria-label="Floating label select example"
        value="<?= $data['developer']['scrumTeamId'] ?? '' ?>">
    ...
    <div class="form-floating mb-3">
      <input type="text" class="form-control" name="documentNumber" placeholder="0123456789" maxlength="10"
        value="<?= $data['developer']['documentNumber'] ?? '' ?>">
